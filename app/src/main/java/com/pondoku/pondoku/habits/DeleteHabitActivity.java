...
import com.pondoku.pondoku.add.AddHabitFragment;
import com.pondoku.pondoku.databinding.ActivityDeleteHabitBinding;
        ...
        documentReference
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        Log.d(AddHabitFragment.UPDATE_COUNT, "DocumentSnapshot successfully updated!");
                        deleteHabit();
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Log.w(AddHabitFragment.UPDATE_COUNT, "Error updating document", e);
                    }
                });
    }
