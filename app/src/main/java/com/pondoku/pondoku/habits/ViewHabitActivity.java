...
public class ViewHabitActivity extends AppCompatActivity {
    ...
    private com.pondoku.pondoku.databinding.ActivityViewHabitBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = com.pondoku.pondoku.databinding.ActivityViewHabitBinding.inflate(getLayoutInflater());
